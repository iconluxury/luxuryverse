...
function Home() {
  ...
  useEffect(() => {
    ...
    gsap.to(exclusiveElement, {
      ...
      onComplete: () => {
        gsap.to(exclusiveSpans, {
          ...
          stagger: 0.1, // Reduced stagger for faster cursor movement
          ease: "power2.out",
          onStart: () => {
          ...
          onUpdate: function () {
            ...
            gsap.set(cursor, {
              ...
              top: { base: "0%", md: "2%" }, // Adjusted for better alignment
            });
          },
        });
      },
    ...
    gsap.to(brandsElement, {
      opacity: 1,
      duration: 0.1,
      delay: exclusiveText.length * 0.1, // Adjusted delay to match faster stagger
      onComplete: () => {
        gsap.to(brandsSpans, {
          opacity: 1,
          y: 0,
          ...
          onUpdate: function () {
            ...
            gsap.set(cursor, {
              x: (currentIndex + 1) * letterWidth + 15, // Position after the current letter
